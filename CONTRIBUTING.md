# Contributing to donejs-piyush-5767-jshint

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/Piyush5767/donejs-piyush-5767-jshint) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-piyush-5767-jshint, you can start by going to its [fork page](https://github.com/Piyush5767/donejs-piyush-5767-jshint/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-piyush-5767-jshint
```
